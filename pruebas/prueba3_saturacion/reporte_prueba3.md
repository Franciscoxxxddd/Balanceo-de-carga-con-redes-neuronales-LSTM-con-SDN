# Reporte Técnico: Prueba 3 - Estrés Crítico (Saturación)

## 1. Descripción de la Prueba
**Objetivo:** Sobrecarga sostenida en los enlaces troncales para evaluar el balanceo bajo saturación crítica (>10Mbps).
...
- **Criterio Principal:** Mantener el Throughput total lo más alto posible; minimizar IPLR frente a congestión severa.
...
| :--- | :---: | :---: | :--- |
| **Pérdida de Paquetes (IPLR)** | 0.12% | 0.00% | Menor a 5% es óptimo. |
| **Latencia Promedio (IPTD)** | 15.18 ms | 15.47 ms | Menor es mejor. |
| **Jitter Promedio (IPDV)** | 2.86 ms | 2.93 ms | Idealmente < 5ms para VoIP. |

### 4.2 Estándar RFC 2544 (Rendimiento Físico)
| Métrica | Round Robin (RR) | IA (LSTM) | Lectura |
| :--- | :---: | :---: | :--- |
| **Throughput Promedio Servidor** | 10.12 Mbps | 10.10 Mbps | Mayor es mejor (límite: 10Mbps total). |
